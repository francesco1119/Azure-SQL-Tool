/** 
Finding Duplicate or Overlapping Indexes
...
AS (
	SELECT SCHEMA_DATA.name AS schema_name
		...
		,STUFF((
				SELECT ', ' + COLUMN_DATA_KEY_COLS.name + ' ' + CASE 
