...
SELECT SCHEMA_NAME(o.Schema_ID) + N'.' + o.[NAME] AS [Object Name]
	...
	,(sp.rows_sampled * 100) / sp.rows AS [Actual Sample Percent]
	,sp.modification_counter
	,st.row_count
	,st.used_page_count
	,'Helps discover possible problems with out-of-date statistics. Also gives you an idea which indexes are the most active' AS Info
